 ...
 *
 * الأجزاء القادمة (محجوزة ضمن نفس ملف التخزين الموحَّد dms.json):
 *  2/10: التصنيف الهرمي والمجلدات + النقل/النسخ + الأرشفة اليدوية/التلقائية
 *  3/10: سير عمل الاعتماد (Workflow) القابل للتخصيص لكل نوع مستند
 *  4/10: التوقيع الإلكتروني (اعتماد متعدد المستويات + ختم زمني + سجل توقيعات)
