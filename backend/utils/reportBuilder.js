 ...
 * >> الجزء 4/10: التقارير التفاعلية + الرسوم البيانية (انظر reportInteractive.js).
...
const DATA_SOURCES = {
  ...
  budgets: {
    ...
    fetch(filters) {
      ...
      // تصحيح: listBudgets في budgetManagement.js تُعيد النتائج ضمن result.data
      // (وليس result.items كما هو الحال في projectManagement.listProjects). كان
      // الاعتماد الخاطئ على result.items يجعل هذا المصدر يعيد دائماً مصفوفة فارغة.
